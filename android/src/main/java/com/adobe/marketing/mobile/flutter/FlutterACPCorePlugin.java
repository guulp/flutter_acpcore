...
public class FlutterACPCorePlugin implements FlutterPlugin, MethodCallHandler {
    ...
    public void onMethodCall(MethodCall call, @NonNull Result result) {
        ...
        if ("extensionVersion".equals(call.method)) {
            ...
            MobileCore.log(LoggingMode.DEBUG, ACPCORE_TAG, "downloadRules() cannot be invoked on Android");
            result.success(null);
            ...
            MobileCore.log(LoggingMode.DEBUG, ACPCORE_TAG, "setAppGroup() cannot be invoked on Android");
            result.success(null);
    ...
    private void handleDispatchEvent(final Result result, final Object arguments) {
        ...
        Event event = FlutterACPCoreDataBridge.eventFromMap(eventMap);
        ...
        MobileCore.dispatchEventWithResponseCallback(event,
                new AdobeCallback<Event>() {
                    ...
                    public void call(Event event) {
                        Map eventMap = FlutterACPCoreDataBridge.mapFromEvent(event);
    ...
    private void handleDispatchResponseEvent(final Result result, final Object arguments) {
        ...
        Event responseEvent = FlutterACPCoreDataBridge.eventFromMap(responseEventMap);
        Event requestEvent = FlutterACPCoreDataBridge.eventFromMap(requestEventMap);
    ...
    private void setLogLevel(final Object arguments) {
        ...
        LoggingMode loggingMode = FlutterACPCoreDataBridge.loggingModeFromString(mode);
    ...
    private void handleSetPrivacyStatus(final Object arguments) {
        ...
        MobilePrivacyStatus mobilePrivacyStatus = FlutterACPCoreDataBridge.privacyStatusFromString(privacyStatus);
